...
def main():
    ...
    with st.container():
        ...
        st.write("Welcome to our advanced Breast Cancer Prediction tool. This application seamlessly integrates with your cytology lab data to assist in the crucial diagnosis of breast cancer from tissue samples. Utilizing a robust machine learning model, our app accurately predicts whether a breast mass is benign or malignant based on the precise measurements received from your lab. For enhanced flexibility, you can also manually input or fine-tune these measurements using the intuitive sliders provided in the sidebar.")
